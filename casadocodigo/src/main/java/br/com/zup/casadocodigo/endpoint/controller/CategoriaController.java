...
import br.com.zup.casadocodigo.endpoint.v1.dto.request.CategoriaRequest;
import br.com.zup.casadocodigo.endpoint.v1.dto.response.CategoriaResponse;
...
public class CategoriaController {
	...
	public ResponseEntity<CategoriaResponse> criarCategoria(@RequestBody @Valid CategoriaRequest categoriaRequest){
		...
		return ResponseEntity.ok().body(new CategoriaResponse().toModel(categoria));
